...
class PoseBrowserLauncherNode:
    """Launch the PAL Pose Browser server from inside ComfyUI."""
    ...
    def start_server(self):
        ...
        try:
            ...
            message = "PAL Pose Browser launched on http://127.0.0.1:8189"
            print(f"[PoseBrowserLauncher] {message}")
            return (message,)
        except Exception as e:
            message = f"Failed to launch Pose Browser: {e}"
            print(f"[PoseBrowserLauncher] {message}")
            return (message,)
